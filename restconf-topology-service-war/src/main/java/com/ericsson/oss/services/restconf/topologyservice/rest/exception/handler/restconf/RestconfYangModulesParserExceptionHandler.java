...
/**
 * Exception handler for {@code RestconfYangModulesParserException} type.
 * <br/>
 * Status Code: 500.
 * <br/>
 ...
 */
@Provider
public class RestconfYangModulesParserExceptionHandler extends AbstractExceptionHandler
        implements ExceptionMapper<RestconfYangModulesParserException> {
    @Override
    public Response toResponse(final RestconfYangModulesParserException exception) {
