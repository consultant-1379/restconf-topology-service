...
/**
 * Exception handler for {@code InternalServerErrorException} type. <br/>
 * Status Code: 500. <br/>
 * Exception Description: General server error.
 */
@Provider
public class InternalServerErrorExceptionHandler extends AbstractExceptionHandler implements ExceptionMapper<InternalServerErrorException> {
