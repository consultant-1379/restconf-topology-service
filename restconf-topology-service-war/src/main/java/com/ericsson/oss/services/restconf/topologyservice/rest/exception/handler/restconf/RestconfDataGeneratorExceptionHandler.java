...
/**
 * Exception handler for {@code RestconfDataGeneratorException} type.
 * <br/>
 * Status Code: 500.
 * <br/>
 ...
 */
@Provider
public class RestconfDataGeneratorExceptionHandler extends AbstractExceptionHandler implements ExceptionMapper<RestconfDataGeneratorException> {

    @Override
    public Response toResponse(final RestconfDataGeneratorException exception) {
