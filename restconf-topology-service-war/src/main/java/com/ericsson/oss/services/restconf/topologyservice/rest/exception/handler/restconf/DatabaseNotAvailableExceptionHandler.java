...
/**
 * Exception handler for {@code DatabaseNotAvailableException} type.
 * <br/>
 * Status Code: 500.
 * <br/>
 ...
 */
@Provider
public class DatabaseNotAvailableExceptionHandler extends AbstractExceptionHandler implements ExceptionMapper<DatabaseNotAvailableException> {

    @Override
    public Response toResponse(final DatabaseNotAvailableException exception) {
