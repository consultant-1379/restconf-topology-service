 ...
 * Lldp data provider.
 */
@YangDataProvider(yangModel = "lldp-data-not-found", eModelMapping = @EModelMapping())
public class LldpDataProvider extends AbstractRestconfDataProvider {
    public LldpDataProvider() {
        super(LldpDataProvider.class);
    }
}
