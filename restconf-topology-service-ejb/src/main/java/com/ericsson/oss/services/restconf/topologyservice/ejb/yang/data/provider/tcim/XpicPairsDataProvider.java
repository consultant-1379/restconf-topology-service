...
/**
 * Xpic pairs data provider.
 */
@YangDataProvider(yangModel = "ietf-microwave-radio-link:xpic-pairs", eModelMapping = @EModelMapping())
public class XpicPairsDataProvider extends AbstractRestconfDataProvider {
    public XpicPairsDataProvider() {
        super(XpicPairsDataProvider.class);
    }
}
