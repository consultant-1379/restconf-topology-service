...
/**
 * HrlbGroup data provider.
 */
@YangDataProvider(yangModel = "hrlb-group-not-found", eModelMapping = @EModelMapping())
public class HrlbGroupDataProvider extends AbstractRestconfDataProvider {
    public HrlbGroupDataProvider() {
        super(HrlbGroupDataProvider.class);
    }
}
