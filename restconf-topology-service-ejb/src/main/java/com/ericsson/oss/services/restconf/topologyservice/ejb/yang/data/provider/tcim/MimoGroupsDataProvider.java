...
/**
 * MimoGroups data provider.
 */
@YangDataProvider(yangModel = "ietf-microwave-radio-link:mimo-groups", eModelMapping = @EModelMapping())
public class MimoGroupsDataProvider extends AbstractRestconfDataProvider {
    public MimoGroupsDataProvider() {
        super(MimoGroupsDataProvider.class);
    }
}
