...
/**
 * Pending termination point data provider.
 */
@YangDataProvider(yangModel = "ietf-network:node-not-needed", eModelMapping = @EModelMapping())
public class PendingTerminationPointDataProvider extends AbstractRestconfDataProvider {
    public PendingTerminationPointDataProvider() {
        super(PendingTerminationPointDataProvider.class);
    }
}
