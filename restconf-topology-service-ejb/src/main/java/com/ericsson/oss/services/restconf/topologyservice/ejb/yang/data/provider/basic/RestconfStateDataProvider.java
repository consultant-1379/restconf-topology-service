...
/**
 * Restconf state data provider.
 */
@YangDataProvider(yangModel = "ietf-restconf-monitoring:restconf-state", eModelMapping = @EModelMapping())
public class RestconfStateDataProvider extends AbstractRestconfDataProvider {
    public RestconfStateDataProvider() {
        super(RestconfStateDataProvider.class);
    }
}
