 ...
 */
@YangDataProvider(yangModel = "ietf-subscribed-notifications:filters", eModelMapping = @EModelMapping())
public class FiltersDataProvider extends AbstractRestconfDataProvider {

    public FiltersDataProvider() {
        super(FiltersDataProvider.class);
    }
}
