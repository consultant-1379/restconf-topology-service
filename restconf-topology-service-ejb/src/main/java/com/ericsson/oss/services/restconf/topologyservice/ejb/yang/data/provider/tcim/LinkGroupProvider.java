...
/**
 * LinkGroup data provider.
 */
@YangDataProvider(yangModel = "link-group-not-found", eModelMapping = @EModelMapping())
public class LinkGroupProvider extends AbstractRestconfDataProvider {
    public LinkGroupProvider() {
        super(LinkGroupProvider.class);
    }
}
