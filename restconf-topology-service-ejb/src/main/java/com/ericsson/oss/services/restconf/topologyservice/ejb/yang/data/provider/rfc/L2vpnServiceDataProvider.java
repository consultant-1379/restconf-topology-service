...
/**
 * L2vpn service data provider.
 */
@YangDataProvider(yangModel = "ietf-l2vpn-svc:l2vpn-svc", eModelMapping = @EModelMapping())
public class L2vpnServiceDataProvider extends AbstractRestconfDataProvider {
    public L2vpnServiceDataProvider() {
        super(L2vpnServiceDataProvider.class);
    }
}
