...
/**
 * Restconf subscriptions data provider.
 */
@YangDataProvider(yangModel = "ietf-subscribed-notifications:subscriptions", eModelMapping = @EModelMapping())
public class RestconfSubscriptionsDataProvider extends AbstractRestconfDataProvider {
    public RestconfSubscriptionsDataProvider() {
        super(RestconfSubscriptionsDataProvider.class);
    }
}
