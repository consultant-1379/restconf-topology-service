...
/**
 * Traffic engineering data provider.
 */
@YangDataProvider(yangModel = "ietf-te:te", eModelMapping = @EModelMapping())
public class TrafficEngineeringDataProvider extends AbstractRestconfDataProvider {
    public TrafficEngineeringDataProvider() {
        super(TrafficEngineeringDataProvider.class);
    }
}
