...
/**
 * Network state data provider.
 */
@YangDataProvider(yangModel = "ietf-network-state:networks", eModelMapping = @EModelMapping())
public class NetworkStateDataProvider extends AbstractRestconfDataProvider {
    public NetworkStateDataProvider() {
        super(NetworkStateDataProvider.class);
    }
}
