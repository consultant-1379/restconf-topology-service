...
/**
 * Restconf streams provider.
 */
@YangDataProvider(yangModel = "ietf-subscribed-notifications:streams", eModelMapping = @EModelMapping())
public class RestconfStreamsDataProvider extends AbstractRestconfDataProvider {
    public RestconfStreamsDataProvider() {
        super(RestconfStreamsDataProvider.class);
    }
}
