 ...
 */
@YangDataProvider(yangModel = "ietf-interfaces:interfaces-state", eModelMapping = @EModelMapping())
public class InterfacesStateDataProvider extends AbstractRestconfDataProvider {
    public InterfacesStateDataProvider() {
        super(InterfacesStateDataProvider.class);
    }
}
