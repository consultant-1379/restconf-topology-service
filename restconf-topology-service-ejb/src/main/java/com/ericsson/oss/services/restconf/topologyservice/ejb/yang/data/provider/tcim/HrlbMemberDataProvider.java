...
/**
 * HrlbMember data provider.
 */
@YangDataProvider(yangModel = "hrlb-groups-not-found", eModelMapping = @EModelMapping())
public class HrlbMemberDataProvider extends AbstractRestconfDataProvider {
    public HrlbMemberDataProvider() {
        super(HrlbMemberDataProvider.class);
    }
}
