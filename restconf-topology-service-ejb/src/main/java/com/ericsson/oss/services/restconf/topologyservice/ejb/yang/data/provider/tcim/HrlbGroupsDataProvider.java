...
/**
 * HrlbGroups data provider.
 */
@YangDataProvider(yangModel = "hrlb-groups-not-found", eModelMapping = @EModelMapping())
public class HrlbGroupsDataProvider extends AbstractRestconfDataProvider {
    public HrlbGroupsDataProvider() {
        super(HrlbGroupsDataProvider.class);
    }
}
